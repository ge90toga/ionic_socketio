angular.module('chat.controllers', [])
  ...
  .controller('ChatCtrl', function ($scope, $stateParams, $ionicPopup, $timeout, Socket, Chat,$log) {
    ...
    Socket.on('connect', function () {
      ...
      // add a test user
      Socket.emit('add user', 'iHorde Test');
      Chat.setUsername('iHorde Test');
      // --- add a test user--
  ...
  .controller('ChatListCtrl', function ($scope) {
    $scope.chats = [ // some fake data
      {name:'Mike', lastText:'How are you?', face:'/img/max.png'},
      {name:'Linus', lastText:'Thanks',face:'/img/perry.png'},
      {name:'iHorde', lastText:'Meet me after 5.',face:'img/adam.jpg'}
    ];
  })
